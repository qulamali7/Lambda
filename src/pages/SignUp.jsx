...
const SignUp = () => {
    return (
        <>
            <section className="flex items-center h-screen py-[50px]">
                <div className="lg:m-auto h-full w-6/12 flex flex-col justify-between items-center ">
                    ...
                    <div className="max-w-[384px] w-full m-auto p-[12px] flex flex-col gap-[16px]">
                        <p className="font-work text-[24px] font-semibold text-center font-['Work Sans, sans-serif']">Create account</p>
                        <form className="flex flex-col gap-[12px]">
                            <button className='flex items-center justify-center gap-[10px] w-full h-10 rounded-xl bg-white  text-[rgb(10,11,12)] leading-6 px-[24px] text-[16px] font-semibold shadow-[rgba(10,11,12,0.1)_0px_1px_2px,rgba(10,11,12,0.1)_0px_0px_0px_1px_inset] hover:bg-[rgba(10,11,11,0.05)] transition-[all] duration-[0.5s] ease font-inter '>
                            ...
                            <div className="w-full flex items-center justify-center gap-[10px]">
                                ...
                                <span className="text-[rgba(10,11,11,0.3)] font-semibold text-xs leading-[150%] font-inter">OR</span>
                                <div className="h-[1px]  w-[43%] bg-[rgba(10,11,12,0.1)]"></div>
                            </div>
                            ...
                            <Btn />
                            <p className="font-inter text-center font-normal text-xs text-[rgba(10,11,11,0.5)]">Already have an account? <Link to={"/login"} className="font-inter cursor-pointer text-[rgb(0,178,120)] text-xs font-semibold leading-[1.5em] p-0 hover:text-[rgb(0,108,73)]  transition-[all] duration-[0.5s] ease">Log in</Link></p>
                        </form>
                    </div>
                    <p className="font-inter w-full max-w-[400px] text-center text-[rgba(10,11,11,0.5)] text-xs leading-[150%]">By clicking “Continue with Email” or “Continue with Google” above, you acknowledge that you have read and understood, and agree to Workee’s <Link className=' font-inter text-[rgb(10,11,12)] leading-[1.5em] text-[11px]'>Terms & Conditions</Link> and <Link className='font-inter text-[rgb(10,11,12)] leading-[1.5em] text-[11px]'>Privacy Policy</Link>.</p>
                </div>
                <div className="lg:hidden overflow-hidden bg-[#E2FEF4] py-[16px] px-[32px] backdrop-blur-lg m-6 rounded-[40px] w-6/12 text-[32px] font-semibold text-[rgba(10,11,11,0.3)] leading-[130%]">
                    Get a personal website, schedule video calls with clients, manage bookings, and get paid directly to your account
                    <img src="https://app.workee.net/assets/sign-up-background-95e4383b.png" alt="" />
                </div>
            </section>
        </>
    )
